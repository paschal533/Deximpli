      ...
      <Grid container direction="column">
        {address ? (
          loading ? (
            ...
            <>
              {liquidity.length > 0 ? (
                liquidity.map((item: any, index: any) => (
                  <Accordion
                    key={`liq-list-${index}`}
                ...
                <h1 className="text-center h-[100px] bg-cream justify-center items-center flex rounded-lg w-full text-md font-semibold">
                  No Liquidity Found in you account
                </h1>
              )}
            </>
          )
        ) : (
          <h1 className="text-center bg-cream justify-center h-[100px] items-center flex rounded-lg w-full text-md font-semibold">
            Please connect to a wallet to view your liquidity.
          </h1>
        )}
      </Grid>
    </div>
