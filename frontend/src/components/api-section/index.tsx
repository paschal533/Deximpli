    ...
    <div className="justify-center mt-16 flex bg-cream md:h-[100%] h-full w-full" >
            <div className='w-full p-4 md:pl-20 md:p-10 flex max-w-[1300px] h-full flex-wrap items-center content-center place-content-center justify-center align-middle'>
                <div className='md:mt-0 md:w-[45%] mt-14 items-center content-center place-content-center w-full h-full flex-col justify-center align-middle'>
                  <Slide damping={0.2}>
                    <h1 className='text-4xl font-bold text-[#191A1A] mb-8'>SDK Integration for Programmers</h1>
                    <Fade className='text-xl mr-6 text-[#191A1A]'>An SDK enabling developers to integrate Deximpli's email-based wallet into their dapps for seamless, secure web3 transactions as simple as using a credit card.</Fade>
                    <Link href="/dashboard"> <motion.button
                ...
                <Slide direction='right' damping={0.1} className='md:mt-0 md:block hidden md:w-[50%] w-full mt-8'>
                    {/* <Image src="/images/api.png" width={500} height={500} alt="banner-image" /> */}
                    <AnimatedBeamDemo />
                </Slide>
                <Slide direction='right' damping={0.1} className='md:mt-0 md:hidden block md:w-[50%] w-full mt-8'>
