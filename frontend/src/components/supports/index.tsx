...
function Support() {
  return (
    <main className="mt-8 ">
      <h1 className="text-center w-full text-3xl md:text-5xl">
        <Fade damping={0.1}>Cross-Chain Bridged with over</Fade>{" "}
        <Fade damping={0.1} className="font-bold">
          <span>
            <NumberTicker value={50} />+ blockchains
          </span>
        </Fade>
      </h1>
