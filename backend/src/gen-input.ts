...
export const MAX_BODY_PADDED_BYTES = 1472; // NOTE: this must be the same as the arg to sha the remainder number of bytes in the email in main args circom
...
export async function generateInputs(rawEmail: string) {
  ...
  console.log(emailVerifierInputs)
