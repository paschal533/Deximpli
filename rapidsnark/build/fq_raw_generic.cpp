...
{
    memcpy(pRawResult, pRawA, sizeof(FqRawElement));
}
...
void Fq_rawMMul1(FqRawElement pRawResult, const FqRawElement pRawA, uint64_t pRawB)
{
    ...
    product0[N-1] = mpn_mul_1(product0, pRawA, Fq_N64, pRawB);
...
void Fq_rawFromMontgomery(FqRawElement pRawResult, const FqRawElement pRawA)
{
    ...
    mpn_copyi(product0, pRawA, Fq_N64); product0[N-1] = 0;
...
void Fq_rawSwap(FqRawElement pRawResult, FqRawElement pRawA)
{
    ...
    Fq_rawCopy(temp, pRawResult);
    Fq_rawCopy(pRawResult, pRawA);
    Fq_rawCopy(pRawA, temp);
}
