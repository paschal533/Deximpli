      ...
      <div className=" md:p-0 p-4 w-full">
          ...
          <div className="flex justify-between mt-2 w-full">
            ...
            >
              {Object.keys(tokenA).length === 0 ? (
                ...
                <div className="!w-full cursor-pointer bg-white flex justify-between font-bold py-1 px-2 rounded-2xl">
                  <Image
        ...
        <section>
          {address ? (
            <div>
              {tokensSelected ? (
                <div className="h-[100px] space-x-4 mt-2 font-semibold justify-between py-4 px-4 items-center flex bg-cream rounded-xl  w-full">
                  <Grid item md={4}>
                    <Grid container direction="column" alignItems="center">
                      <Grid item>
                        <h1 className="font-semibold">
                          {getPrice(indexTokenB)}
                        </h1>
                      </Grid>
                      <Grid item>
                        <h1>
                ...
                <h1 className="h-[50px] font-semibold text-[#D7009A] justify-center items-center flex bg-cream rounded-xl mt-2  w-full">
                  No information! Please select a pair of tokens.
                </h1>
              )}
              {tokensSelected && (
