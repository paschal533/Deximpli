  ...
  return (
    <div className="w-full !max-w-[1000px] mb-8">
      {address ? (
                    ...
                    >
                      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                        <div className="w-full justify-between flex font-semibold text-md pr-2">
                          <Grid item>
                            {pool.assetToken.name} ({pool.assetToken.symbol})
                          </Grid>
                          <Grid item>
                            Lending APY: {formatInterest(pool.lendingInterest)}
                          </Grid>
                          <Grid item>
                            Borrowing APY: {formatInterest(pool.borrowInterest)}
                          </Grid>
                        </div>
                      </AccordionSummary>
                      <AccordionDetails>
        ...
        <p className="bg-cream p-3 items-center flex justify-center h-[100px] text-center rounded-lg mt-2 font-semibold">
          Please connect to a wallet to view asset pools.
        </p>
      )}
    </div>
  );
