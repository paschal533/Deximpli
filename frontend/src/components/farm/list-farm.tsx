          ...
          !loadingInfo ? (
            <>
              ...
              {farmingPools.length > 0 ? (
                farmingPools
                  .filter((p: any) =>
                    hideExpired ? p.rewardEndBlock > currentBlock : true,
                  )
                      ...
                      >
                        <div className="flex-col w-full">
                          <div className="flex w-full font-semibold text-md justify-between">
                            <Grid item className="font-semibold text-md">
                              Stake:{" "}
                              <span className="text-md font-medium">
                                {item.stakedToken.symbol}
                              </span>
                            </Grid>
                            <Grid item>
                              Earn:{" "}
                            ...
                            <Grid item>
                              {item.rewardToken.symbol} Earned:{" "}
                              <span className="text-md font-medium">
                                {ethers.utils.formatUnits(
                                  item.pendingReward,
                                  item.rewardToken.decimals,
                                )}
                              </span>
                            </Grid>
                          </div>
                      ...
                      <AccordionDetails>
                        <div className="w-full mb-3 space-x-2 flex justify-between">
                          <div className="w-1/2">
                            ...
                            >
                              <Button
                                className="text-[#D7009A] rounded-md bg-white font-semibold"
                                fullWidth
                                disabled={currentBlock >= item.rewardEndBlock}
                                onClick={
                                  () => {} /*navigate(`deposit?pool=${item.address}`)*/
                                }
                              >
                                Deposit
                              </Button>
                          ...
                          <div className="w-1/2">
                            ...
                            >
                              <Button
                                className="text-[#D7009A] rounded-md bg-white font-semibold"
                                fullWidth
                                disabled={item.stakedAmount.lte(0)}
                              >
                                Withdraw
                              </Button>
                            </IntegrationTrigger>
                        ...
                        <div className="w-full space-x-2 flex justify-between">
                          <div className="w-1/2">
                            <Button
                              className="text-[#D7009A] w-full rounded-md bg-white font-semibold"
                              fullWidth
                              disabled={item.pendingReward.lte(0)}
                          ...
                          <div className="w-1/2">
                            ...
                            >
                              <Button
                                ...
                                fullWidth
                                onClick={
                                  () => {} /*navigate(`supply?pool=${item.address}`)*/
                                }
                              >
                                Supply Reward
                              </Button>
                ...
                <p className="bg-cream p-3 items-center flex justify-center h-[100px] text-center rounded-lg mt-2 font-semibold">
                  No Farming Pool Found
                </p>
              )}
            </>
          ) : (
            <div className="bg-cream p-3 items-center flex justify-center h-[100px] text-center rounded-lg mt-2 font-semibold">
              <CircularProgress />
            </div>
          )
        ) : (
          <p className="bg-cream p-3 items-center flex justify-center h-[100px] text-center rounded-lg mt-2 font-semibold">
            Please connect to a wallet to view staking pools.
          </p>
        )}
      </Grid>
    </div>
...
export default ListFarmingPools;
